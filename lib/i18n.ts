...
const M = {
  fr: {
    ...
    noticeRulesEyebrow: "Suppléments",
    noticeRule1Where: "Poisson au rez-de-chaussée",
    noticeRule2Where: "Plats traditionnels en terrasse",
  ...
  en: {
    ...
    noticeRulesEyebrow: "Surcharges",
    noticeRule1Where: "Fish on the ground floor",
    noticeRule2Where: "Traditional dishes on the terrace",
  ...
  ar: {
    ...
    noticeRulesEyebrow: "زيادات",
    noticeRule1Where: "السمك في الطابق الأرضي",
    noticeRule2Where: "الأطباق التقليدية في الشرفة",
