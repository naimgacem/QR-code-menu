...
const M = {
  fr: {
    ...
    noticeRulesEyebrow: "Supplément de prix",
    noticeRuleWhere: "Plats traditionnels en terrasse (sauf bourak)",
  ...
  en: {
    ...
    noticeRulesEyebrow: "Price surcharge",
    noticeRuleWhere: "Traditional dishes on the terrace (bourak excluded)",
  ...
  ar: {
    ...
    noticeRuleWhere: "الأطباق التقليدية في الشرفة (ما عدا البوراك)",
